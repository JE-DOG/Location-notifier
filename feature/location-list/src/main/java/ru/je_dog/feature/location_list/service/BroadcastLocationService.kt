...
import ru.je_dog.core.feature.location.LocationManager
import ru.je_dog.core.feature.model.GeoPointPresentation
import ru.je_dog.core.feature.notification.NotificationChannelService
...
class BroadcastLocationService @Inject constructor (
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        val goalMeters = intent.run {
            val extraKey = Resources.getSystem()
                .getString(ru.je_dog.core.feature.R.string.meters_extra_key)
